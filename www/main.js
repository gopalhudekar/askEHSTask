...
const routes = [
    {
        path: 'category',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_category_category_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/category/category.module */ 8712)).then(m => m.CategoryPageModule)
    },
    {
        path: 'create-category',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_create-category_create-category_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/create-category/create-category.module */ 7900)).then(m => m.CreateCategoryPageModule)
    },
    {
        path: '',
        redirectTo: 'category',
